...
void disp_driver_init(void)
{
    ...
    il3820_init();
#elif defined CONFIG_LVGL_TFT_DISPLAY_CONTROLLER_IL0389
    il0389_init();
#endif
}
...
#elif defined CONFIG_LVGL_TFT_DISPLAY_CONTROLLER_IL0389
    il0389_flush(drv, area, color_map);
#endif
}
...
#elif defined CONFIG_LVGL_TFT_DISPLAY_CONTROLLER_IL0389
    il0389_set_px_cb(disp_drv, buf, buf_w, x, y, color, opa);
#endif
}
